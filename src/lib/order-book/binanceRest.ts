...
// narrowing keeps working if these errors ever flow through Query (fetchJson.ts contract).

import { HttpError, ParseError } from "@/lib/query/fetchJson.ts"
import { z } from "zod"
import { type DepthSnapshot, depthSnapshotSchema } from "./binanceSchemas.ts"
